%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Description: Speech enhancement by LP model.
% Reference paper: A Study on Restoration of Bone-Conducted Speech with
%                  MTF-Based and LP-Based Models
...
% PI
fileName_wns = strcat(folderName_wns, 'pinkNoise.wav');
...
NN = 20;
kk = 1;                       % 5, 9/4/2021, forgot why set kk=5 for the Sigma data in May
...
for m=0:nframes-1
  ...
  %x_res = kk * filter([1 -A_left(2:end)], [1 -A_right(2:end)], xw_l);
...
%  y_left = real(ifft(X_left));
  ...
  %audiowrite('enhancedData_LP.wav', yout, Fs);
  %audiowrite('enhancedData_LP_again.wav', yout, Fs);        % 9/4/2021
  
  %---------------------------------------------
  % 9/4/2021
  %---------------------------------------------
  % OTOG2_case01, set output file name
  %outputFileName = strcat(outputFolderName, 'LPbased_eh_OTOG2_SpeechWind3mpsFanB_mic15_mic7.wav');
  %outputFileName_1ch = strcat(outputFolderName, 'LPbased_eh_OTOG2_SpeechWind3mpsFanB_mic7_1ch.wav');
  %outputFileName_wns = strcat(outputFolderName_ens, 'LPbased_eh_wns_OTOG2_SpeechWind3mpsFanB_mic15_mic7.wav');
  %outputFileName_wns_1ch = strcat(outputFolderName_ens, 'LPbased_eh_wns_OTOG2_SpeechWind3mpsFanB_mic7_1ch.wav');
  %outputFileName_wns = strcat(outputFolderName_ens, 'LPbased_eh_HPF_wns_OTOG2_SpeechWind3mpsFanB_mic15_mic7.wav');
  %outputFileName_wns_1ch = strcat(outputFolderName_ens, 'LPbased_eh_HPF_wns_OTOG2_SpeechWind3mpsFanB_mic7_1ch.wav');
  
  % OTOG2_case02, set file name 
  %outputFileName = strcat(outputFolderName, 'LPbased_eh_OTOG2_SpeechWind3mpsTunnelA_mic15_mic7.wav');
  %outputFileName_1ch = strcat(outputFolderName, 'LPbased_eh_OTOG2_SpeechWind3mpsTunnelA_mic7_1ch.wav');
  %outputFileName_wns = strcat(outputFolderName_ens, 'LPbased_eh_wns_OTOG2_SpeechWind3mpsTunnelA_mic15_mic7.wav');
  %outputFileName_wns_1ch = strcat(outputFolderName_ens, 'LPbased_eh_wns_OTOG2_SpeechWind3mpsTunnelA_mic7_1ch.wav');
  %outputFileName_wns = strcat(outputFolderName_ens, 'LPbased_eh_HPF_wns_OTOG2_SpeechWind3mpsTunnelA_mic15_mic7.wav');
  %outputFileName_wns_1ch = strcat(outputFolderName_ens, 'LPbased_eh_HPF_wns_OTOG2_SpeechWind3mpsTunnelA_mic7_1ch.wav');
  
  % OTOG2_case03, set file name 
  %outputFileName = strcat(outputFolderName, 'LPbased_eh_OTOG2_SpeechWind5mpsFanA_mic15_mic7.wav');
  %outputFileName_1ch = strcat(outputFolderName, 'LPbased_eh_OTOG2_SpeechWind5mpsFanA_mic7_1ch.wav');
  %outputFileName_wns = strcat(outputFolderName_ens, 'LPbased_eh_wns_OTOG2_SpeechWind5mpsFanA_mic15_mic7.wav');
  %outputFileName_wns_1ch = strcat(outputFolderName_ens, 'LPbased_eh_wns_OTOG2_SpeechWind5mpsFanA_mic7_1ch.wav');
  %outputFileName_wns = strcat(outputFolderName_ens, 'LPbased_eh_HPF_wns_OTOG2_SpeechWind5mpsFanA_mic15_mic7.wav');
  %outputFileName_wns_1ch = strcat(outputFolderName_ens, 'LPbased_eh_HPF_wns_OTOG2_SpeechWind5mpsFanA_mic7_1ch.wav');
  
  % OTOG2_case04, set file name 
  %outputFileName = strcat(outputFolderName, 'LPbased_eh_OTOG2_SpeechWind5mpsTunnelB_mic15_mic7.wav');
  %outputFileName_1ch = strcat(outputFolderName, 'LPbased_eh_OTOG2_SpeechWind5mpsTunnelB_mic7_1ch.wav');
  %outputFileName_wns = strcat(outputFolderName_ens, 'LPbased_eh_wns_OTOG2_SpeechWind5mpsTunnelB_mic15_mic7.wav');
  %outputFileName_wns_1ch = strcat(outputFolderName_ens, 'LPbased_eh_wns_OTOG2_SpeechWind5mpsTunnelB_mic7_1ch.wav');
  outputFileName_wns = strcat(outputFolderName_ens, 'LPbased_eh_HPF_wns_OTOG2_SpeechWind5mpsTunnelB_mic15_mic7.wav');
  outputFileName_wns_1ch = strcat(outputFolderName_ens, 'LPbased_eh_HPF_wns_OTOG2_SpeechWind5mpsTunnelB_mic7_1ch.wav');
